...
const RetroPhotographerSite = ({ subdomain }) => {
        ...
        <div className="text-center">
          <div className="relative">
            <div className="w-20 h-20 border-4 border-gray-700 rounded-full animate-spin mx-auto mb-6">
              <div className="absolute top-0 left-0 w-20 h-20 border-4 border-transparent rounded-full animate-spin" style={{ borderTopColor: websiteData?.studio?.primary_color || '#D97706' }}></div>
            </div>
            <Camera className="h-8 w-8 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 animate-pulse" style={{ color: websiteData?.studio?.secondary_color || '#059669' }} />
          </div>
          <p className="text-xl font-light tracking-wider animate-typewriter" style={{ fontFamily: '"Courier New", monospace', color: websiteData?.studio?.secondary_color || '#059669' }}>Loading Retro Experience...</p>
        </div>
      </div>
    );
  }
  ...
  if (!websiteData) {
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#2A2A2A' }}>
        <div className="text-center">
          <Camera className="h-24 w-24 mx-auto mb-6" style={{ color: websiteData?.studio?.secondary_color || '#059669' }} />
          <h2 className="text-3xl font-bold mb-3" style={{ fontFamily: '"Bebas Neue", sans-serif', color: websiteData?.studio?.primary_color || '#D97706' }}>Not Found</h2>
          <p style={{ color: websiteData?.studio?.secondary_color || '#059669', fontFamily: '"Inter", sans-serif' }}>Portfolio unavailable</p>
        </div>
      </div>
    );
  }

  const { photographer, studio, photos } = websiteData;
  ...
  return (
    <div className="min-h-screen text-white relative overflow-hidden" style={{ backgroundColor: '#2A2A2A', fontFamily: '"Inter", sans-serif' }}>
        ...
        <section className="min-h-screen flex items-center justify-center relative">
          <div className="text-center z-10 max-w-5xl mx-auto px-6">
            <div className="mb-10 relative">
              <div className="w-40 h-40 mx-auto rounded-lg overflow-hidden border-4 border-white/20 shadow-xl mb-8 group rotate-2 hover:rotate-0 transition-transform duration-500" style={{ borderColor: `${secondaryColor}30` }}>
              ...
              <div className="absolute -top-2 -right-2 w-10 h-10 rounded-full border-4 animate-pulse" style={{ backgroundColor: secondaryColor, borderColor: primaryColor }}></div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-fadeInUp animation-delay-400">
              ...
              >
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{ background: `linear-gradient(to right, ${secondaryColor}30, transparent)` }}></div>
              ...
              <button 
                ...
                style={{ borderColor: `${primaryColor}40`, color: secondaryColor, backgroundColor: 'transparent', fontFamily: '"Bebas Neue", sans-serif' }}
              >
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 animate-slideInLeft" style={{ borderColor: `${primaryColor}20` }}>
                    <Award className="h-8 w-8 mb-3" style={{ color: secondaryColor }} />
                    <div className="text-2xl font-bold" style={{ color: primaryColor, fontFamily: '"Bebas Neue", sans-serif' }}>{photographer?.experience_years || '8'}+</div>
                    <div className="text-sm" style={{ color: `${secondaryColor}cc`, fontFamily: '"Inter", sans-serif' }}>Years Experience</div>
                  </div>
                  <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 animate-slideInRight" style={{ borderColor: `${primaryColor}20` }}>
                    <Star className="h-8 w-8 mb-3" style={{ color: secondaryColor }} />
                    <div className="text-2xl font-bold" style={{ color: primaryColor, fontFamily: '"Bebas Neue", sans-serif' }}>500+</div>
                    <div className="text-sm" style={{ color: `${secondaryColor}cc`, fontFamily: '"Inter", sans-serif' }}>Happy Clients</div>
                  </div>
                </div>
              </div>
              <div className="relative">
                <div className="relative group">
                  {photographer?.profile_image ? (
                    ...
                    <div className="w-full h-96 rounded-lg flex items-center justify-center" style={{ background: `linear-gradient(to bottom right, ${primaryColor}, ${secondaryColor})` }}>
                      <Camera className="h-24 w-24 text-white/30" />
                    </div>
                  )}
                  <div className="absolute inset-0 rounded-lg" style={{ background: `linear-gradient(to top, ${primaryColor}40, transparent)` }}></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="min-h-screen py-24 px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              <div className="space-y-8">
                <div className="space-y-6">
                  {photographer?.user?.email && (
                    <div className="flex items-center gap-4 p-6 bg-white/10 backdrop-blur-md rounded-xl hover:bg-white/20 transition-all duration-300 animate-slideInLeft" style={{ borderColor: `${primaryColor}20` }}>
                      <Mail className="h-6 w-6" style={{ color: secondaryColor }} />
                      <span style={{ color: `${secondaryColor}cc`, fontFamily: '"Inter", sans-serif' }}>{photographer.user.email}</span>
                    </div>
                  )}
                  {photographer?.phone && (
                    <div className="flex items-center gap-4 p-6 bg-white/10 backdrop-blur-md rounded-xl hover:bg-white/20 transition-all duration-300 animate-slideInLeft" style={{ borderColor: `${primaryColor}20` }}>
                      <Phone className="h-6 w-6" style={{ color: secondaryColor }} />
                      <span style={{ color: `${secondaryColor}cc`, fontFamily: '"Inter", sans-serif' }}>{photographer.phone}</span>
                    </div>
                  )}
                  {studio?.location && (
                    <div className="flex items-center gap-4 p-6 bg-white/10 backdrop-blur-md rounded-xl hover:bg-white/20 transition-all duration-300 animate-slideInLeft" style={{ borderColor: `${primaryColor}20` }}>
                      <MapPin className="h-6 w-6" style={{ color: secondaryColor }} />
                      <span style={{ color: `${secondaryColor}cc`, fontFamily: '"Inter", sans-serif' }}>{studio.location}</span>
                    </div>
                  )}
                </div>

                <div className="flex gap-4 animate-slideInLeft">
                  <button className="w-12 h-12 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center hover:bg-white/20 transition-all duration-300 hover:scale-110" style={{ borderColor: `${primaryColor}20` }}>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-xl p-8 animate-slideInRight" style={{ borderColor: `${primaryColor}20` }}>
                <div className="space-y-6">
                  <input
                    type="text"
                    ...
                    style={{ 
                      ...
                      '::placeholder': { color: `${secondaryColor}50` },
      ...
      {selectedPhoto && (
        ...
        >
          <div className="max-w-5xl max-h-full relative rotate-2 hover:rotate-0 transition-transform duration-500">
            <img 
      ...
      <style jsx>{`
        ...
        .animate-retroFloat { animation: retroFloat 5s ease-in-out infinite; }
  ...
  if (!photos || photos.length === 0) {
    return (
      <div className="text-center py-24">
        ...
        <h3 className="text-2xl font-bold mb-2" style={{ color: primaryColor, fontFamily: '"Bebas Neue", sans-serif' }}>Gallery Coming Soon</h3>
        <p style={{ color: `${secondaryColor}cc`, fontFamily: '"Inter", sans-serif' }}>Timeless captures in the making</p>
      </div>
    );
  }
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {photos.map((photo, index) => (
        ...
        >
          ...
          <div className={`absolute inset-0 transition-all duration-500 ${hoveredIndex === index ? 'bg-black/30' : 'bg-transparent'}`}>
          ...
          <div className={`absolute bottom-4 left-4 right-4 p-4 transition-all duration-300 ${hoveredIndex === index ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
            <div className="bg-white/80 rounded-lg p-3" style={{ borderColor: `${primaryColor}20` }}>
              <h4 className="font-bold text-sm uppercase" style={{ color: primaryColor, fontFamily: '"Bebas Neue", sans-serif' }}>{photo.title || `Untitled ${index + 1}`}</h4>
              <p className="text-xs" style={{ color: `${secondaryColor}cc`, fontFamily: '"Inter", sans-serif' }}>{photo.category || 'Photography'}</p>
            </div>
          </div>
        </div>
      ))}
